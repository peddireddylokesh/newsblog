...
<div class="container">
        ...
        <a href="create_article.php"> <button type="button" class="btn btn-info add-new right"><i class="fa fa-plus "></i> Add New</button></a>
            ...
            while ($row = mysqli_fetch_array($result)) {
                ...
                <div class="col-lg-4 md-2 sm-1 wow animate__fadeInDown" data-wow-duration="1s">
                    <div class="card mb-5">
                        ...
                        <div class="card-body">
                            <h6><i class="fa-clock"></i><?php echo $row['created_at'];?></h6>

                            <h3><?php echo $row['title'];?></h3>
                            <p><?php echo $row['description'];?></p>
                            <span><a href="create_article.php?id=<?php echo $row['id'];?>" class="btn btn-warning">Edit</a></span>
                            <span><a href="delete.php?id=<?php echo $row['id'];?>&type=article" class="btn btn-danger">Delete</a> </span>
                        </div>
                    </div>
                </div>
                <?php
